...
TODO explain multi and dual classing
...
_A stalwart champion of the battlefield._
...
_A terrifying warrior who fights with reckless abandon._

**Requirements:** Str 12+, Wis no greater than 11
...
- **Sincerity:** Speak and act without pretense or deceit. Strive for integrity between your thoughts, words, and deeds.
- **Respect:** Honor and obey your superiors, and do not disdain your enemy, for without them your skill has no meaning.
- **Vengeance:** All debts, whether dishonor or gratitude, must be repaid.
...
**Specialized Skills:** Bludgeon, Bow, Curved Sword, Dagger, Hand-to-Hand, Sling, Straight Sword

**Backstab:** Backstab unaware foes for x2 damage (+1 multiple every 4 levels).

**Read Magic Scrolls:** At 9th level, cast spells from magic scrolls.

**Thieves' Guild:** A 10th-level or higher Thief who establishes a stronghold attracts 4d6 Thieves of level 1–4 as followers. These recruits form the foundation of a new Thieves' Guild under the character’s leadership. While highly profitable, such an enterprise is likely to provoke a turf war with local criminal factions.

| Level | XP Required | Hit Dice (d6) | Fort Save | Ref Save | Will Save | Thief Features     | Assassin Features     | Ninja Features       |
| :---: | :---------: | :-----------: | :-------: | :------: | :-------: | ------------------ | --------------------- | -------------------- |
|   1   |      0      |       1       |    –2     |    2     |    –2     | Backstab           | Assassinate, Backstab | Backstab, Ki (1/day) |
|   2   |     600     |       2       |    –1     |    3     |    –1     |                    |                       | Ki (2/day)           |
|   3   |    1,800    |       3       |     0     |    4     |     0     |                    |                       |                      |
|   4   |    4,200    |       4       |     0     |    4     |     0     |                    |                       |                      |
|   5   |    9,000    |       5       |     1     |    5     |     1     |                    |                       | Ki (3/day)           |
|   6   |   18,000    |       6       |     2     |    6     |     2     |                    |                       |                      |
|   7   |   35,000    |       7       |     2     |    6     |     2     |                    |                       |                      |
|   8   |   60,000    |       8       |     3     |    7     |     3     |                    |                       | Ki (4/day)           |
|   9   |   100,000   |       9       |     4     |    8     |     4     | Read Magic Scrolls | Read Magic Scrolls    | Read Magic Scrolls   |
|  10   |   160,000   |      10       |     4     |    8     |     4     | Thieves' Guild     | Thieves' Guild        | Thieves' Guild       |
|  11   |   280,000   |    10 + 2     |     5     |    9     |     5     |                    |                       | Ki (5/day)           |
|  12   |   400,000   |    10 + 4     |     6     |    10    |     6     |                    |                       |                      |
|  13   |   520,000   |    10 + 6     |     6     |    10    |     6     |                    |                       |                      |
|  14   |   640,000   |    10 + 8     |     7     |    11    |     7     |                    |                       | Ki (6/day)           |
|  15   |   760,000   |    10 + 10    |     8     |    12    |     8     |                    |                       |                      |
|  16   |   880,000   |    10 + 12    |     8     |    12    |     8     |                    |                       |                      |
|  17   |  1,000,000  |    10 + 14    |     9     |    13    |     9     |                    |                       | Ki (7/day)           |

+120,000 XP required and +2 HP each additional level
...
|  10   |   220,000   |      10       |     8     |    4     |     6     |               |                      |                      |
|  11   |   300,000   |      11       |     9     |    5     |     7     |               |                      |                      |
|  12   |   400,000   |    11 + 1     |    10     |    6     |     7     |               |                      |                      |
|  13   |   500,000   |    11 + 2     |    10     |    6     |     8     |               |                      |                      |
|  14   |   600,000   |    11 + 3     |    11     |    7     |     8     |               |                      |                      |
|  15   |   700,000   |    11 + 4     |    12     |    8     |     9     |               |                      |                      |
|  16   |   800,000   |    11 + 5     |    12     |    8     |     9     |               |                      |                      |
|  17   |   900,000   |    11 + 6     |    12     |    8     |    10     |               |                      |                      |
|  18   |  1,000,000  |    11 + 7     |    12     |    8     |    10     |               |                      |                      |

+100,000 XP required and +1 HP each additional level
...
- Swashbuckler - Dynamic Combat Movement

Cleric - Evil Clerics can use Slash/Pierce, but have to cast "evil" versions of spells?

- Friar
- Runepriest - third sight ability from 2e Vikings book?

Mage

- Incantatrix - Dragon 90, bring spell progression back to normal, allow 1 free choice of spell at level up, learns spells from their list as MU does (Illusionist/Druid scroll requires Comprehend Languages), can learn from a Tutor in half normal time spells both they and that class can cast
  - eidetic memory, does not use a spellbook. Still prepares spells or no? casts spells known of any level with spell points?
  - steal spell ability: save allowed, if foe fails save, spell is randomly selected (or chosen if ESP used first) and given to Incant as a "mental scroll" which costs spell points equal to its level. It can then be released without costing spell points. If it's on the Incant's list, it can be learned from the "mental scroll" by the usual process for physical scrolls.
  - give unique spells at level 1 and 2, and Extension spells at lower levels (remember they can apply to spells cast by other people)
- Illusionist - don't have to use Read Magic or roll to learn spells. Can automatically learn spells on their list from scrolls they find (including MU scrolls with a Learn Spell roll). Player can choose 1 spell from the list to learn at level up (can get their uniques this way without requiring Illusionist NPCs). Try to make 1/10 NPCs spellcasters/scrolls/spellbooks Illusionist though. Can MUs read Illusionist scrolls if spell is on their list? Yes, with Read Magic. what happens with spells that have differnt spell levels/stats between MUs and Illos? The character reading the scroll casts their class's version of the spell. Illusionists need to pass Learn Spell check to learn from MU scroll, but not from Illo scroll. Read Magic removed entirely from game or used according to my old HR (auto success at, or massive bonus to, the Learn Spell check)
- Mystic/Savant/Oracle/Summoner? - Dungeoneer 16-17, White Dwarf

TODO

- do any Illusionist/Incantatrix/Jester spells shared with MU differ in content? Or just in level?
- Illusionist unique spells make sense (they have their own language, which MUs can't read). Incantatrix and Jester? Make unique spells into special abilities instead? Or else they don't need to be learned by these classes and they can't write scrolls anyway.
- incantatrix and jester - limited spell list (restricts cast and read), Cast Magic Spells, Read Magic Scrolls, choose 1 spell at level up
- illusionist - limited spell list (restricts cast and read), Cast Illusionist Spells (no Learn roll from Illusionist book/scroll, Learn roll necessary from Mage book/scroll), Read Magic Scrolls, Read Illusionist Scrolls, Write Illusionist Scrolls, choose 1 spell at level up
- mage - Cast Magic Spells, Read Magic Scrolls, Write Magic Scrolls, choose 1 spell at level up
- bard - Cast Magic Spells, Read Magic Scrolls, Read Cleric Scrolls, Read Illusionist Scrolls, Read Druid Scrolls, Write Magic Scrolls, do NOT choose 1 spell at level up

Paladin - base is a late spellcaster, like 1e

- Inquisitor?
- Undead Hunter?

Ranger - base is a late spellcaster, like 1e

- Stalker - no magic spells/palantir use, better thief skills?
- Archer?
...
|   8   |   180,000   |       9        |     7     |    3     |     5     |                    |                      |
|   9   |   360,000   |     9 + 4      |     8     |    4     |     6     |                    |                      |
|  10   |   540,000   |     9 + 8      |     8     |    4     |     6     |                    |                      |
|  11   |   720,000   |     9 + 12     |     9     |    5     |     7     |                    |                      |
|  12   |   900,000   |     9 + 16     |    10     |    6     |     7     |                    |                      |
|  13   |  1,080,000  |     9 + 20     |    10     |    6     |     8     |                    |                      |

+180,000 XP required and +4 HP each additional level
...
| Level | XP Required | Hit Dice (d8) | Fort Save | Ref Save | Will Save | Druid Features | Witch Features |
| :---: | :---------: | :-----------: | :-------: | :------: | :-------: | -------------- | -------------- |
|   1   |      0      |       1       |     2     |    –2    |     2     |                |                |
|   2   |     900     |       2       |     3     |    –1    |     2     |                |                |
|   3   |    2,700    |       3       |     4     |    0     |     3     |                |                |
...
**Requirements:** Dex 12+, Int 9+, Cha 12+, Chaotic alignment
...
**Requirements:** Str 9+, Int 9+, Cha 12+
...
**Specialized Skills:** As base Bard, plus Runelore.
