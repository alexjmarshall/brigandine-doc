...
1. **Commitment**: The Attacker declares how many dice they are moving to the **exchange**. The Defender then does the same.
...
- **Counter**: Launch an attack into the attacker (hopefully into a **feint**). If the attacker **feints**, your damage lands first, damaging their follow-up pool first. If they are **simply attacking**, their damage lands first against your **exchange** dice. Roll any you have left for damage against them.
