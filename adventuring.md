...
Stealth enables characters to evade enemies, scout their positions, or strike from surprise. We distinguish sight from sound to clarify what happens in the fiction during stealth and reduce the need for GM interpretation. Opposed skill checks (**Hide** vs. **Spot** and **Sneak** vs. **Listen**) determine the success of stealthy actions. The target's **Alertness**, **Attention**, and **Awareness** determine how they respond, whether stealthy actions automatically succeed or fail, and the advantages stealthy characters receive.

### Alertness

A creature's Alertness determines how they react when they notice something suspicious (typically by succeeding at a passive **Listen** or **Spot** check).

**Alert:** Will approach the suspicious sight or sound and **Search** the area to determine what it is.

**Relaxed:** Will make an active **Listen** or **Spot** check to examine the source of the sight or sound, but not investigate further if it fails. However, they will become Alert.

A sleeping creature can't make passive **Spot** checks, and its passive **Listen** suffers a -5 penalty. On a success, they wake up and respond as if Relaxed.

If you can see a creature, you can tell how alert it is.
...
If you can see a creature, you can tell whether it's Observing you.
