...
Passive skill checks use a fixed value of 10 + your skill bonus and do not require an action. Active checks are rolled and usually take an action, unless specified to occur along with your movement or another action.

## Hide

As an action, duck behind cover or deeper into concealment to hide. You must have **Concealment** or **Cover**, and none of your enemies in the area can be **Observing** you. Compare your Hide check to the highest passive Spot among those that can see you. On a success, you are **Unseen**. On a failure, something suspicious catches their eye (see **Alertness** for how they respond).

Note that **Cover** provides a bonus to Hide checks, and **Concealment** a penalty to Spot checks.

Keep note of your Hide check and compare it to the passive Spot checks of any new enemies who enter the area, or the active Spot checks of any attempts to look for you.

If you make an attack while hidden, you receive the benefits of being **Unseen** on that attack, but are seen immediately afterward. If you move out into the open while **Observed** you are immediately seen. If you move while under **Cover** or **Concealment**, observers notice a suspicious motion and respond according to their **Alertness**.

Making contact with a hidden creature, including an attack that beats their touch AC, reveals their appearance.
...
As an action, sweep the area around you for hidden creatures. Compare your Search check to the touch AC of any creatures within your reach. On a success, you pinpoint their location. If they are hiding (and not invisible due to magic or environmental conditions), you also reveal their appearance.
...
As part of your movement, make a Sneak check to avoid revealing your location. Compare your check to the highest passive Listen among those who can hear you. If you are **Unseen** and sneak successfully, you become **Undetected** as they lose track of your location. On a failure, they hear you and pinpoint your location.
